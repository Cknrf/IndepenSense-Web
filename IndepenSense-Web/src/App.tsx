  ...
  return (
    <div className="main-container">
      ...
      <div className="main-interface">
        ...
        {!intervalInformation && <span>Unable To Retrieve Information</span>}

        {intervalInformation && activeSection === "HomeSection" && (
          <HomeSection {...intervalInformation}></HomeSection>
        )}

        {/* Alert Section */}

        {activeSection === "AlertSection" && <AlertSection></AlertSection>}

        {/* Location Section */}

        {intervalInformation && activeSection === "LocationSection" && (
          <LocationSection {...intervalInformation}></LocationSection>
        )}
